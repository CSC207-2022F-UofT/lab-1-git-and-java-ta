...
public class IntroLab {
    ...
    /**
     * An example method that calls on printLabMessage with utorID.
     */
    public static String ditianqu() {
        return printLabMessage("Hello", "ditianqu", true,
                "Welcome to CSC207!");
    }
